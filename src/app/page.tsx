    ...
    <main className = {`bg-gray-100 w-full h-full`}>
      <div id="TopContent" className="sm:bg-[url('../../public/code-glasses.jpg')] sm:bg-cover sm:bg-no-repeat sm:text-white md:h-[100vh]">
        <div id="header" className="flex justify-between p-2 px-4 relative sm:hidden">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" id="Burger-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" onClick={(e) => burgerClickedHandler(e)} className="w-6 h-6 cursor-pointer sm:hidden">
        ...
        <div id="body" className="p-4 mt-12 text-wrap text-center sm:pb-12 md:mt-18 md:p-4">
          ...
          <div id="btns" className="my-14 flex justify-center gap-4">
            <Link href={"#"} className="border-b-2 p-3 rounded text-md hover:border-b-purple-600 transition-all duration-300 ease-out select-none sm:hover:text-purple-500 md:text-lg md:border-2 md:hover:border-purple-500 md:px-5">
              Sign Up
            </Link>

            <Link href={"#"} className="border-b-2 p-3 rounded text-md select-none hover:border-b-purple-600 sm:hover:text-purple-500 md:text-lg md:border-2 md:hover:border-purple-500 md:px-5">
              Log In
            </Link>
          </div>
        </div>
